...
int invert(uint32_t x, uint32_t p, uint32_t n) {
    uint32_t mask = ((1U << (p - n + 1)) - 1) << n; // create mask for range p thru n (left to right)
...
void print_binary(uint32_t num, uint32_t p, uint32_t n) {
    for (int i = sizeof(num) * 8 - 1; i >= 0; i--) {
        if (i <= p && i >= n) {
            // print the inverted bits in green to assess output
...
int main() {
    ...
    // output:   0b1100101010101110000001001010
    int p = 10;
    int n = 5;
